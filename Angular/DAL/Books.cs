...
namespace Angular.DAL
{
    public class Books
    {
        ...
        public List<Books> CategoriesGetList()
        {
            DataSet dts = null;
            List<Books> categorieslist = new List<Books>();
            try
            {
                ...
                for (int i = 0; i < dts.Tables[0].Rows.Count; i++)
                {
                    categorieslist.Add(new Books()
                    {
                        CategoryId = Convert.ToString(dts.Tables[0].Rows[i]["CategoryId"]),
                        CategoryName = dts.Tables[0].Rows[i]["CategoryName"].ToString(),
        ...
        public List<Books> PublishersGetList()
        {
            DataSet dts = null;
            List<Books> publisherslist = new List<Books>();
            try
            {
                ...
                for (int i = 0; i < dts.Tables[0].Rows.Count; i++)
                {
                    publisherslist.Add(new Books()
                    {
                        PublisherId = Convert.ToString(dts.Tables[0].Rows[i]["PublisherId"]),
                        PublisherName = dts.Tables[0].Rows[i]["PublisherName"].ToString(),
